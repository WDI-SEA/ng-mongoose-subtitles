(function() {
    ...
    app.component("subtitleVideo", {
      templateUrl: 'views/subtitle-video.html',
      controller: VideoCtrl,
      controllerAs: 'vm'
    })
    
    function VideoCtrl($scope, $element, $interval, ScriptService) {
    ...
    VideoCtrl.$inject = ['$scope', '$element', '$interval', 'ScriptService'];
})();
